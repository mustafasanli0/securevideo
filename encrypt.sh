...
ffmpeg \
    ...
    -hls_list_size 0 \
    -hls_time 6 \
    -hls_segment_filename ./$1/hls.%d.ts \
    -y \
    ./$1/hls.m3u8
...
II=0
echo "#EXTM3U\n#EXT-X-VERSION:3\n#EXT-X-TARGETDURATION:10\n#EXT-X-MEDIA-SEQUENCE:0">./$1/hls.m3u8.crypto

while true;
do

if [ -f "./$1/hls.$II.ts" ]; then
Duration=$(ffprobe -i ./$1/hls.$II.ts -show_entries format=duration -v quiet -of csv="p=0")
echo "#EXTINF:"$Duration",\nhls."$II".ts.encrypted">>./$1/hls.m3u8.crypto
else
break
fi

    cat "./$1/hls.$II.ts" | shCryptoAesXxxCbcRawEncrypt 0123456789abcdef0123456789abcdef > "./$1/hls.$II.ts.encrypted"
    echo "encrypted file hls.$II.ts -> hls.$II.ts.encrypted"
    II=$(( II + 1 ))
done
echo "#EXT-X-ENDLIST">>./$1/hls.m3u8.crypto

cat ./$1/hls.m3u8.crypto | shCryptoAesXxxCbcRawEncrypt 0123456789abcdef0123456789abcdef base64 > ./$1/hls.m3u8.encrypted
cat ./$1/hls.m3u8.encrypted | shCryptoAesXxxCbcRawDecrypt 0123456789abcdef0123456789abcdef base64
